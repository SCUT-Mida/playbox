...
- **羁绊阵法**：相邻部署特定武将自动激活（五虎上将、卧龙凤雏、群雄逐鹿、三国鼎立……）。
- **气势大招**：击杀积累气势，满 100 可释放**火烧连营**清场。
- **点将抽卡**：开局赠送金币（可十连抽）；初始阵容来自抽卡，多国随机。抽到重复卡可**合并升星**，永久提升武将攻防。
- **存档续战**：战局在波间空档/布阵时自动存档，下次进入可从存档**继续**上次出征。
- **倍速推进**：战斗中可随时切换 1× / 2× 倍速（右上角），长关卡节奏更轻快。
- **特殊敌军**：黄巾巫医周期治疗友军（须优先集火后排）、南蛮战象重甲攻坚（惧法，漏怪扣双血）。
- **关卡**（8 关，难度循序渐进）：黄巾之乱（教学★）→ 汜水关（★★）→ 虎牢关（★★★）→ 徐州之战（★★★）→ 官渡之战（★★★★）→ 长坂坡（★★★★）→ 赤壁之战（★★★★★）→ 南蛮之乱（★★★★★）。里程碑关卡结尾有 BOSS（张角 / 董卓 / 袁绍 / 曹军旗舰 / 蛮王孟获）。
